...
var pickup_spawn_x = irandom_range(sprite_get_width(Meat), room_width - sprite_get_width(Meat));
var pickup_spawn_y = irandom_range(sprite_get_height(Test), room_height - sprite_get_height(Meat));
